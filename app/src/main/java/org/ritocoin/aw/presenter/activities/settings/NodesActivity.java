...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BRSharedPrefs.putCurrentWalletIso(this, "RITO");
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final RitoWalletManager wm = RitoWalletManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        RitoWalletManager wm = RitoWalletManager.getInstance(this);
    ...
    private void createDialog() {
        ...
        mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final RitoWalletManager wm = RitoWalletManager.getInstance(app);
